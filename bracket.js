...
//     let firstNames = ['John', 'Jane', 'Mary', 'Mark', 'Bob', 'Tom', 'Sam', 'Steve', 'Bill', 'Mike', 'John', 'Jane', 'Mary', 'Mark', 'Bob', 'Tom', 'Sam', 'Steve', 'Bill', 'Mike']
...
//     let fullNames = []
//     for(let i = 0; i < arr; i++){
//         let randomFirst = Math.floor(Math.random() * firstNames.length)
//         let randomLast = Math.floor(Math.random() * lastNames.length)
//         fullNames.push(`${firstNames[randomFirst]} ${lastNames[randomLast]}`)
//     }
//     return fullNames
// }
